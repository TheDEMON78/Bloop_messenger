...
// Scale helper to convert logical scaler values to physical using monitor scaling.
// See https://docs.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-getdpiforwindow
